programa
{
  ...
  funcao divisao(inteiro A, inteiro B, inteiro Resultado)
        {
        	Resultado = A%B
        escreva("A divisão da Variavél num 1 num2 é igual a: ",+Resultado+"\n")
        }

  funcao multiplicacao(inteiro A, inteiro B, inteiro Resultado)
        {
        	Resultado = A*B
        escreva("A multiplicação da Variavél num 1 num2 é igual a: ",+Resultado+"\n")
        }
